...
<script id="tmpl-bp-avatar-webcam" type="text/html">
	<# if ( ! data.user_media ) { #>
		<div id="bp-webcam-message">
			<p class="warning"><?php esc_html_e( 'Your browser does not support this feature.', 'jvbpd' ); ?></p>
		</div>
	<# } else { #>
		...
		<div class="avatar-crop-management">
			...
			<div id="avatar-crop-actions">
				<button type="button" class="button avatar-webcam-capture"><?php echo esc_html_x( 'Capture', 'button', 'jvbpd' ); ?></button>
				<button type="button" class="button avatar-webcam-save"><?php echo esc_html_x( 'Save', 'button', 'jvbpd' ); ?></button>
			</div>
		</div>
	<# } #>
</script>
