...
<div class="subnav-filters filters no-ajax" id="subnav-filters">
	...
	<div class="subnav-search clearfix">
		...
		<?php if ( 'activity' === bp_current_component() ) : ?>
			<div class="feed"><a href="<?php bp_sitewide_activity_feed_link(); ?>" class="bp-tooltip" data-bp-tooltip="<?php esc_attr_e( 'RSS Feed', 'jvbpd' ); ?>"><span class="bp-screen-reader-text"><?php esc_html_e( 'RSS', 'jvbpd' ); ?></span></a></div>
		<?php endif; ?>
