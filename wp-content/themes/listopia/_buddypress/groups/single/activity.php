...
<h2 class="bp-screen-title<?php echo ( ! bp_is_group_home() ) ? ' bp-screen-reader-text' : ''; ?>">
	<?php esc_html_e( 'Group Activities', 'jvbpd' ); ?>
</h2>
...
<div class="subnav-filters filters clearfix">
	...
	<ul>
		...
		<li class="feed"><a href="<?php bp_group_activity_feed_link(); ?>" class="bp-tooltip no-ajax" data-bp-tooltip="<?php esc_attr_e( 'RSS Feed', 'jvbpd' ); ?>"><span class="bp-screen-reader-text"><?php esc_html_e( 'RSS', 'jvbpd' ); ?></span></a></li>
