...
<div id="item-actions" class="group-item-actions">
	...
	<?php if ( bp_current_user_can( 'groups_access_group' ) ) : ?>
		...
		<h2 class="bp-screen-reader-text"><?php esc_html_e( 'Group Leadership', 'jvbpd' ); ?></h2>

		<dl class="moderators-lists">
			<dt class="moderators-title"><?php esc_html_e( 'Group Administrators', 'jvbpd' ); ?></dt>
		...
		?>
			...
			<dl class="moderators-lists">
				<dt class="moderators-title"><?php esc_html_e( 'Group Mods', 'jvbpd' ); ?></dt>
