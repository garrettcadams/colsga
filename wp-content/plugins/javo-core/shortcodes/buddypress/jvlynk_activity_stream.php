...
if ( function_exists('bp_is_active') && bp_is_active('activity') ) {
	...
	$output .= '<div class="wpb_wrapper">';
		$output .= '<div class="activity jvbpd-activity-streams">';
	...
	if ( bp_has_activities( $params ) ) {
			...
			while ( bp_activities() ) : bp_the_activity();
				...
				$output .= '<li class="'. bp_get_activity_css_class() .'" id="activity-'. bp_get_activity_id() .'">';
					$output .= '<div class="activity-avatar rounded">';
						$output .= '<a class="jvbpd-activity-avatar" title="'.__( 'View Profile','jvfrmtd' ).'" href="'. bp_get_activity_user_link() .'">';
					...
					$output .= '<div class="activity-content">';
						...
						$output .= '<div class="activity-meta">';
							if ( bp_get_activity_type() == 'activity_comment' ){
								$output .= '<a href="'.bp_get_activity_thread_permalink(). '" class="view bp-secondary-action" title="'.__( 'View Conversation', 'jvfrmtd' ). '">'.__( 'View Conversation', 'jvfrmtd' ).'</a>';
							}
							...
							if ( is_user_logged_in() ){
								...
								if ( bp_activity_can_favorite() ){
									if ( !bp_get_activity_is_favorite() ){
										$output .= '<a href="'.bp_get_activity_favorite_link().'" class="fav bp-secondary-action" title="'.esc_attr( __('Mark as Favorite', 'jvfrmtd') ).'"></a>';
									}else{
										$output .= '<a href="'.bp_get_activity_unfavorite_link().'" class="unfav bp-secondary-action" title="'.esc_attr( __('Remove Favorite', 'jvfrmtd') ).'"></a>';
									}
								}
						...
						if ( bp_get_activity_type() == 'activity_comment' ){
							$output .= '<a href="'. bp_get_activity_thread_permalink() . '" class="view bp-secondary-action" title="'. __( 'View', 'jvfrmtd' ) .'">'. __( 'View', 'jvfrmtd' );
		...
		$output .= '<div class="alert alert-info">' . __("Right now there is no activity to show", 'jvfrmtd') .'</div>'  ;
	}
