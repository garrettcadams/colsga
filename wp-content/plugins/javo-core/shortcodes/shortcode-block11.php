<?php
class jvbpd_block11 extends Jvbpd_Shortcode_Parse
{
	...
	public function loop( $queried_posts )
	{
		...
		if( ! empty( $queried_posts ) ) : foreach( $queried_posts as $index => $post ) {
			$javoArticle2	= new module2( $post );
			switch( $columns ) :
				case 2: echo "<div class='col-md-6 col-sm-6'>"; break;
				case 3: echo "<div class='col-md-4 col-sm-4'>"; break;
				case 4: echo "<div class='col-md-3 col-sm-3'>"; break;
				case 1:
