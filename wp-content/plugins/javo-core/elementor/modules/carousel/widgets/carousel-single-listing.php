...
class Jv_Carousel_single_listing extends Base {
	public function get_name() { return parent::CAROUSEL_SINGLE_LISTING; }
	public function get_title() { return 'Carousel single listing'; }
	...
	private function add_injections() {
		...
		$this->add_control(
			'overlay_normal_background_color',
			[
				'label' => __( 'Background - Normal', 'jvfrmtd' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .swiper-slide:before' => 'background-color: {{VALUE}}; content: ""; position: absolute; width: 100%; height: 100%; z-index: 1;',
					//'{{WRAPPER}} .swiper-slide .carousel-img-overlay' => 'opacity: 0.5;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .swiper-slide:hover .carousel-img-overlay' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .swiper-slide:hover .carousel-img-overlay' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control( 'slide_lightbox', Array(
			'type' => Controls_Manager::SWITCHER,
			'label' => __( 'Use Slide Lightbox', 'jvfrmtd' ),
		) );
