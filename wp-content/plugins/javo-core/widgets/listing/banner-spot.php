<?php
/**
Widget Name: Banner spot widget
Author: Javo
Version: 1.0.0.0
*/
...
class jvbpd_banner_spot extends Widget_Base {

	public function get_name() {
		return 'jvbpd-banner-spot';
	}

	public function get_title() {
		return 'Banner Spot';   // title to show on elementor
	}
  ...
  protected function _register_controls() {
    ...
    $ad_link = $this->get_settings( 'ad_link' );
    $url = $ad_link['url'];
    $target = $ad_link['is_external'] ? 'target="_blank"' : '';

    //echo '<a href="' . $url . '" ' . $target .'>Visit Website</a>';

  //  $image = $this->get_settings( 'ad_image' );
    //echo '<a href="' . $url . '" ' . $target .'></a>';
