...
class jvbpd_pricing_Table extends Widget_Base {

	public function get_name() {
		return 'jvbpd-price-table';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default' => esc_html__( 'Title', 'jvfrmtd' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Subtitle', 'jvfrmtd' ),
			)
		);
		...
		$this->add_control(
			'featured',
			array(
				'label'        => esc_html__( 'Is Featured?', 'jvfrmtd' ),
		...
		$this->add_control(
			'featured_badge',
			array(
				'label'   => esc_html__( 'Featured Badge', 'jvfrmtd' ),
		...
		$this->add_control(
			'featured_position',
			array(
				'label'   => esc_html__( 'Featured Postition', 'jvfrmtd' ),
		...
		$this->add_responsive_control(
			'featured_left',
			array(
				'label'      => esc_html__( 'Left Indent', 'jvfrmtd' ),
				...
				'selectors'  => array(
					'{{WRAPPER}} .price-table__badge' => 'left: {{SIZE}}{{UNIT}}; right: auto;',
				),
			)
		);
		...
		$this->add_responsive_control(
			'featured_right',
			array(
				'label'      => esc_html__( 'Right Indent', 'jvfrmtd' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%', 'em' ),
				'range'      => array(
					'px' => array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .price-table__badge' => 'right: {{SIZE}}{{UNIT}}; left: auto;',
				),
			)
		);
		...
		$this->add_responsive_control(
			'featured_top',
			array(
				'label'      => esc_html__( 'Top Indent', 'jvfrmtd' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%', 'em' ),
				'range'      => array(
					'px' => array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .price-table__badge' => 'top: {{SIZE}}{{UNIT}};',
				),
				'condition' => array(
					'featured' => 'yes',
				),
		...
		$this->start_controls_section(
			'section_price',
			array(
				'label' => esc_html__( 'Price', 'jvfrmtd' ),
			)
		);
		...
		$this->add_control(
			'price_prefix',
			array(
				'label'   => esc_html__( 'Price Prefix', 'jvfrmtd' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( '$', 'jvfrmtd' ),
			)
		);
		...
		$this->add_control(
			'price',
			array(
				'label'   => esc_html__( 'Price Value', 'jvfrmtd' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( '100', 'jvfrmtd' ),
			)
		);
		...
		$this->add_control(
			'price_suffix',
			array(
				'label'   => esc_html__( 'Price Suffix', 'jvfrmtd' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( '/per month', 'jvfrmtd' ),
			)
		);
		...
		$this->start_controls_section(
			'section_features',
			array(
				'label' => esc_html__( 'Features', 'jvfrmtd' ),
			)
		);
		...
		$repeater->add_control(
			...
			array(
				...
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Feature', 'jvfrmtd' ),
			)
		);
		...
		$repeater->add_control(
			'item_included',
			array(
				'label'   => esc_html__( 'Is Included?', 'jvfrmtd' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'item-included',
				'options' => array(
					'item-included'=> esc_html__( 'Included', 'jvfrmtd' ),
					'item-excluded' => esc_html__( 'Excluded', 'jvfrmtd' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => array(
					array(
						'item_text'     => esc_html__( 'Feature #1', 'jvfrmtd' ),
						'item_included' => 'item-included',
					),
					array(
						'item_text'     => esc_html__( 'Feature #2', 'jvfrmtd' ),
						'item_included' => 'item-included',
					),
					array(
						'item_text'     => esc_html__( 'Feature #3', 'jvfrmtd' ),
						'item_included' => 'item-excluded',
					),
					array(
						'item_text'     => esc_html__( 'Feature #4', 'jvfrmtd' ),
						'item_included' => 'item-excluded',
					),
				),
		...
		$this->start_controls_section(
			'section_action',
			array(
				'label' => esc_html__( 'Action Button', 'jvfrmtd' ),
			)
		);
		...
		$this->add_control(
			'button_before',
			array(
				'label'   => esc_html__( 'Text Before Action Button', 'jvfrmtd' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
			)
		);
		...
		$this->add_control(
			'button_text',
			array(
				'label'   => esc_html__( 'Button Text', 'jvfrmtd' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Buy', 'jvfrmtd' ),
			)
		);
		...
		$this->add_control(
			'button_url',
			array(
				'label'   => esc_html__( 'Button URL', 'jvfrmtd' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( '#', 'jvfrmtd' ),
			)
		);
		...
		$this->add_control(
			'button_after',
			array(
				'label'   => esc_html__( 'Text After Action Button', 'jvfrmtd' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
			)
		);
		...
		$css_scheme = apply_filters(
			'listopia-core/price-table/css-scheme',
			array(
				'table'         => '.price-table',
				'header'        => '.price-table__heading',
				'icon_wrap'     => '.price-table__icon',
				'icon_box'      => '.price-table__icon-box',
				'icon'          => '.price-table__icon-box > *',
				'title'         => '.price-table__title',
				'subtitle'      => '.price-table__subtitle',
				'price'         => '.price-table__price',
				'price_prefix'  => '.price-table__price-prefix',
				'price_value'   => '.price-table__price-val',
				'price_suffix'  => '.price-table__price-suffix',
				'features'      => '.price-table__features',
				'features_item' => '.price-feature',
				'included_item' => '.price-feature.item-included',
				'excluded_item' => '.price-feature.item-excluded',
				'action'        => '.price-table__action',
				'button'        => '.price-table__action .price-table-button',
				'button_icon'   => '.price-table__action .button-icon',
			)
		);

		$this->rendor_css = str_replace('.', '', $css_scheme);


		$this->start_controls_section(
			'section_table_style',
			array(
				'label'      => esc_html__( 'Table', 'jvfrmtd' ),
		...
		$this->add_group_control(
			...
			array(
				'name'           => 'table_border',
				'label'          => esc_html__( 'Border', 'jvfrmtd' ),
				'placeholder'    => '1px',
				'selector'       => '{{WRAPPER}} ' . $css_scheme['table'],
		...
		$this->add_responsive_control(
			'table_padding',
			array(
				'label'      => esc_html__( 'Table Padding', 'jvfrmtd' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_control(
			'subtitle_color',
			array(
				'label'  => esc_html__( 'Subtitle Color', 'jvfrmtd' ),
				'type'   => Controls_Manager::COLOR,
				'scheme' => array(
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_2,
		...
		$this->add_responsive_control(
			'header_padding',
			array(
				'label'      => esc_html__( 'Header Padding', 'jvfrmtd' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_control(
			'price_prefix_color',
			array(
				'label' => esc_html__( 'Price Prefix Color', 'jvfrmtd' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => array(
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Vertical Alignment', 'jvfrmtd' ),
				'type'    => Controls_Manager::SELECT,
				'options' => jvbpd_elements_tools()->verrtical_align_attr(),
				'default' => 'baseline',
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Prefix Display', 'jvfrmtd' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'inline-block' => esc_html__( 'Inline', 'jvfrmtd' ),
					'block'        => esc_html__( 'Block', 'jvfrmtd' ),
				),
		...
		$this->add_control(
			'price_color',
			array(
				'label' => esc_html__( 'Price Color', 'jvfrmtd' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => array(
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
		...
		$this->add_control(
			'price_suffix_color',
			array(
				'label' => esc_html__( 'Price Suffix Color', 'jvfrmtd' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => array(
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Suffix Display', 'jvfrmtd' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'inline-block' => esc_html__( 'Inline', 'jvfrmtd' ),
					'block'        => esc_html__( 'Block', 'jvfrmtd' ),
		...
		$this->add_responsive_control(
			'price_padding',
			array(
				'label'      => esc_html__( 'price Block Padding', 'jvfrmtd' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_responsive_control(
			'features_padding',
			array(
				'label'      => esc_html__( 'Features Block Padding', 'jvfrmtd' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Included Feature', 'jvfrmtd' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control( '_included_bullet_icon', Array(
			'label'       => esc_html__( 'Included Bullet Icon', 'jvfrmtd' ),
			'type' => Controls_Manager::ICONS,
			'fa4compatibility' => 'included_bullet_icon',
			'default' => Array(
				'value' => 'fas fa-check',
				'library' => 'solid',
			),
		...
		$this->add_control(
			'inc_bullet_color',
			array(
				'label' => esc_html__( 'Bullet Color', 'jvfrmtd' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => array(
					'type'  => Scheme_Color::get_type(),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Excluded Feature', 'jvfrmtd' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'_excluded_bullet_icon',
			Array(
				'label'       => esc_html__( 'Excluded Bullet Icon', 'jvfrmtd' ),
				'type' => Controls_Manager::ICONS,
				'fa4compatibility' => 'excluded_bullet_icon',
				'default' => Array(
					'value' => 'fas fa-times',
					'library' => 'solid',
				),
		...
		$this->add_control(
			'exc_text_decoration',
			array(
				'label'   => esc_html__( 'Text Decoration', 'jvfrmtd' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'none',
				'options' => array(
					'none'         => esc_html__( 'None', 'jvfrmtd' ),
					'line-through' => esc_html__( 'Line Through', 'jvfrmtd' ),
				),
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['excluded_item'] . ' .price-feature__text' => 'text-decoration: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Features Divider', 'jvfrmtd' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'features_divider',
			array(
				'label'        => esc_html__( 'Divider', 'jvfrmtd' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'jvfrmtd' ),
				'label_off'    => esc_html__( 'No', 'jvfrmtd' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			array(
				...
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'solid' => esc_html__( 'Solid', 'jvfrmtd' ),
					'double' => esc_html__( 'Double', 'jvfrmtd' ),
					'dotted' => esc_html__( 'Dotted', 'jvfrmtd' ),
					'dashed' => esc_html__( 'Dashed', 'jvfrmtd' ),
				),
				'default' => 'solid',
				'condition' => array(
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Weight', 'jvfrmtd' ),
				'type'    => Controls_Manager::SLIDER,
				'default' => array(
					'size' => 1,
					'unit' => 'px',
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Action Box', 'jvfrmtd' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			'add_button_icon',
			array(
				'label'        => esc_html__( 'Add Icon', 'jvfrmtd' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'jvfrmtd' ),
				'label_off'    => esc_html__( 'No', 'jvfrmtd' ),
				'return_value' => 'yes',
		...
		$this->add_control( '_button_icon', Array(
			'label'       => esc_html__( 'Icon', 'jvfrmtd' ),
			'type' => Controls_Manager::ICONS,
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Icon Position', 'jvfrmtd' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'left'  => esc_html__( 'Before Text', 'jvfrmtd' ),
					'right' => esc_html__( 'After Text', 'jvfrmtd' ),
				),
				'default'     => 'left',
		...
		$this->add_responsive_control(
			'button_icon_margin',
			array(
				'label'      => esc_html__( 'Icon Margin', 'jvfrmtd' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
	...
	protected function render() {
		require jvbpdCore()->widget_path .'/price-table-rendor.php';
	}
}
