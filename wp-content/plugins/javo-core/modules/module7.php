...
class module7 extends Jvbpd_Module
{
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="thum">
							<a href="<?php echo $this->permalink; ?>" class="jv-image-gradient jv-big-grid-overlay"><?php echo $this->thumbnail( 'jvbpd-box', false ); ?></a>

							<div class="meta-gradient">
								<div class="jv-category">
									<a href="<?php echo $this->permalink; ?>">
										<?php echo $this->c( 'item_type', __( "Not Set", 'jvfrmtd' ) ); ?>
									</a>
								</div>
