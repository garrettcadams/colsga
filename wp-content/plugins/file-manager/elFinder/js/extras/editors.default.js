...
fm_menu_icon_base_url = '../wp-content/plugins/file-manager/elFinder/';
	...
	var apps = {},
		...
		initImgTag = function(id, file, content, fm) {
			var node = jQuery(this).children('img:first').data('ext', getExtention(file.mime, fm)),
				spnr = jQuery('<div class="elfinder-edit-spinner elfinder-edit-image"/>')
		...
		pixlrCallBack = function() {
			...
			if (pixlr) {
				...
				p = window.parent;
				ifm = p.jQuery('#'+pixlr[1]+'iframe').hide();
				node = p.jQuery('#'+pixlr[1]).data('resizeoff')();
	...
	return [
		{
			...
			info : {
				...
				iconImg: fm_menu_icon_base_url + 'img/editor-icons.png 0 -48',
				dataScheme: true,
				schemeContent: true,
				openMaximized: true,
				canMakeEmpty: false,
		...
		},
		{
			...
			info : {
				id : 'pixlreditor',
				name : 'Pixlr Editor',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 -128',
				urlAsContent: true,
				schemeContent: true,
				single: true,
				canMakeEmpty: true,
		...
		},
		{
			...
			info : {
				id: 'pixlrexpress',
				name : 'Pixlr Express',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 -112',
				urlAsContent: true,
				schemeContent: true,
				single: true,
				canMakeEmpty: false,
		...
		},
		{
			...
			info : {
				id : 'photopea',
				name : 'Photopea',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 -160',
				single: true,
				noContent: true,
		...
		},
		{
			...
			info : {
				id : 'pixo',
				name : 'Pixo Editor',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 -208',
				dataScheme: true,
				schemeContent: true,
				single: true,
				canMakeEmpty: false,
		...
		},
		{
			...
			info : {
				id : 'creativecloud',
				name : 'Creative Cloud',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 -192',
				dataScheme: true,
				schemeContent: true,
				single: true,
				canMakeEmpty: false,
		...
		},
		{
			...
			info : {
				id : 'aceeditor',
				name : 'ACE Editor',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 -96'
			},
		...
		},
		{
			...
			info : {
				id : 'codemirror',
				name : 'CodeMirror',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 -176'
			},
			load : function(textarea) {
				var fm = this.fm,
		...
		},
		{
			...
			info : {
				id : 'simplemde',
				name : 'SimpleMDE',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 -80'
			},
			exts  : ['md'],
			load : function(textarea) {
				var self = this,
		...
		},
		{
			...
			info : {
				id : 'ckeditor',
				name : 'CKEditor',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 0'
			},
			exts  : ['htm', 'html', 'xhtml'],
			setup : function(opts, fm) {
				var confObj = this;
		...
		},
		{
			...
			info : {
				id : 'ckeditor5',
				name : 'CKEditor5',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 -16'
			},
			exts : ['htm', 'html', 'xhtml'],
		...
		},
		{
			...
			info : {
				id : 'tinymce',
				name : 'TinyMCE',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 -64'
			},
			exts  : ['htm', 'html', 'xhtml'],
			setup : function(opts, fm) {
				var confObj = this;
		...
		},
		{
			info : {
				id : 'zohoeditor',
				name : 'Zoho Editor',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 -32',
				cmdCheck : 'ZohoOffice',
				preventGet: true,
				hideButtons: true,
				syncInterval : 15000,
		...
		},
		{
			...
			info : {
				id : 'ziparchive',
				name : 'btnMount',
				iconImg : fm_menu_icon_base_url + 'img/toolbar.png 0 -416',
				cmdCheck : 'ZipArchive',
		...
		},
		{
			...
			info : {
				id : 'onlineconvert',
				name : 'Online Convert',
				iconImg : fm_menu_icon_base_url + 'img/editor-icons.png 0 -144',
