...
if( isset( $_POST ) && !empty( $_POST ) ){
	...
	$FileManager->options['file_manager_settings']['root_folder_path']  = filter_var($_POST['root_folder_path'], FILTER_SANITIZE_STRING) ? $_POST['root_folder_path'] : '';
	$FileManager->options['file_manager_settings']['root_folder_url']  = filter_var($_POST['root_folder_url'], FILTER_SANITIZE_STRING) ? $_POST['root_folder_url'] : '';
