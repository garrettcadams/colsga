...
class Lava_Ajax_Search_Core {
	...
	public function labelFilter( $label='' ) {
		return str_replace(
			array_keys( $this->instances ), Array(
				esc_html__( "Posts", 'lvbp-ajax-search' ),
				esc_html__( "Pages", 'lvbp-ajax-search' ),
				esc_html__( "Listings", 'lvbp-ajax-search' ),
				esc_html__( "Products", 'lvbp-ajax-search' ),
				esc_html__( "Posts Comments", 'lvbp-ajax-search' ),
				esc_html__( "Forum", 'lvbp-ajax-search' ),
				esc_html__( "Topic", 'lvbp-ajax-search' ),
				esc_html__( "Reply", 'lvbp-ajax-search' ),
				esc_html__( "Members", 'lvbp-ajax-search' ),
				esc_html__( "Groups", 'lvbp-ajax-search' ),
				esc_html__( "Activity", 'lvbp-ajax-search' ),
				esc_html__( "Activity Comments", 'lvbp-ajax-search' ),
				esc_html__( "Messages", 'lvbp-ajax-search' ),
			),  $label
		);
	}
