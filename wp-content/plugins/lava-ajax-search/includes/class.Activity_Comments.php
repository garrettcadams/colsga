...
if (!class_exists('Lava_Ajax_Search_Activity_Comment')):

	class Lava_Ajax_Search_Activity_Comment extends Lava_Ajax_Search_Type {
		private $type = 'activity_comment';

		public static function instance() {
			static $instance = null;
			if (null === $instance) {
				$instance = new Lava_Ajax_Search_Activity_Comment();
			}
			return $instance;
		}
		...
		function sql( $search_term, $only_totalrow_count=false ){
            ...
            return apply_filters(
                'Lava_Ajax_Search_Activity_Comment_sql',
                $sql,
                array(
