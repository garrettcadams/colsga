jQuery( function( $ ) {
	...
	var lava_bpp_listing = function( form, output, template ) {
		this.form			= form;
		this.output			= output;
		this.template		= template;

		if( ! window.__lava_bpp_listing_instance )
			this.init();
	}

	lava_bpp_listing.prototype = {

		constructor : lava_bpp_listing

		, init : function()
		{
			var obj = this;
			window.__lava_bpp_listing_instance = 1;
	...
	new lava_bpp_listing(
		$( "#lava-bpp-listing" )
		, $( "#lava-bpp-output" )
		, $( "#lava-bpp-listing-template" )
	);
