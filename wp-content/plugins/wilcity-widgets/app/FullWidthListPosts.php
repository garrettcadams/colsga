...
class FullWidthListPosts extends \WP_Widget {
	public $aDef = array('title'=>'', 'orderby'=>'post_date', 'order'=>'DESC', 'number_of_posts'=>4, 'post_ids'=>'', 'related_by'=>'');

	public function __construct() {
		// Instantiate the parent object
		parent::__construct( 'wilcity_full_width_list_posts', WILCITY_WIDGET . ' Full Width List Posts');
	}
	...
	public function widget( $aAtts, $aInstance ) {
		...
		if ( !function_exists('wilcityRenderFullWidthListItem') ){
