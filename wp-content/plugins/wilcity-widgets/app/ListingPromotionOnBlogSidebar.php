...
class ListingPromotionOnBlogSidebar extends \WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'wilcity_promote_listings_on_blog_sidebar', WILCITY_WIDGET . ' (Promotion) Blog');
	}
	...
	public function widget( $aAtts, $aInstance ) {
		...
		$aMetaKey = GetSettings::getPromotionKeyByPosition('listing_category_sidebar', true);
        if ( empty($aMetaKey) ){
		    return '';
		}
		$aArgs = array(
